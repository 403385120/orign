...
namespace ZY.BLL
{
    public partial class Batteryinfo_UnLoadingBLL
    {
        private static readonly Batteryinfo_UnLoadingDAL dal = new Batteryinfo_UnLoadingDAL();
        ...
        /// <param name="errMsg">错误信息</param>
        /// <returns></returns>
        public static IList<Batteryinfo_UnLoading> GetList(string filters, string orderBy, int pageSize, int pageIndex, ref string errMsg)
        {
        ...
        /// <param name="errMsg">错误信息</param>
        /// <returns></returns>
        public static IList<Batteryinfo_UnLoading> GetList(string filters, int pageSize, int pageIndex, ref string errMsg)
        {
        ...
        /// <param name="errMsg">错误信息</param>
        /// <returns></returns>
        public static IList<Batteryinfo_UnLoading> GetList(string filters, string orderBy, int TopNo, ref string errMsg)
        {
        ...
        /// <param name="errMsg">错误信息</param>
        /// <returns></returns>
        public static IList<Batteryinfo_UnLoading> GetList(string filters, string orderBy, ref string errMsg)
        {
        ...
        /// <param name="errMsg">错误信息</param>
        /// <returns></returns>
        public static IList<Batteryinfo_UnLoading> GetList(string filters, int TopNo, ref string errMsg)
        {
        ...
        /// <param name="errMsg">错误信息</param>
        /// <returns></returns>
        public static IList<Batteryinfo_UnLoading> GetList(string filters, ref string errMsg)
        {
        ...
        /// <param name="errMsg">错误信息</param>
        /// <returns></returns>
        public static long Add(Batteryinfo_UnLoading model, ref string errMsg)
        {
        ...
        /// <param name="errMsg">错误信息</param>
        /// <returns></returns>
        public static bool Update(Batteryinfo_UnLoading model, ref string errMsg)
        {
        ...
        /// <param name="errMsg">错误信息</param>
        /// <returns></returns>
        public static bool Delete(Batteryinfo_UnLoading model, ref string errMsg)
        {
