...
namespace ZY.BLL
{
    ...
    {
        private static readonly ProductTypeDAL dal = new ProductTypeDAL();
        ...
        /// <param name="errMsg">错误信息</param>
        /// <returns></returns>
        public static IList<ProductType> GetList(string filters, string orderBy, int pageSize, int pageIndex, ref string errMsg)
        {
        ...
        /// <param name="errMsg">错误信息</param>
        /// <returns></returns>
        public static IList<ProductType> GetList(string filters, int pageSize, int pageIndex, ref string errMsg)
        {
        ...
        /// <param name="errMsg">错误信息</param>
        /// <returns></returns>
        public static IList<ProductType> GetList(string filters, string orderBy, int TopNo, ref string errMsg)
        {
        ...
        /// <param name="errMsg">错误信息</param>
        /// <returns></returns>
        public static IList<ProductType> GetList(string filters, string orderBy, ref string errMsg)
        {
        ...
        /// <param name="errMsg">错误信息</param>
        /// <returns></returns>
        public static IList<ProductType> GetList(string filters, int TopNo, ref string errMsg)
        {
        ...
        /// <param name="errMsg">错误信息</param>
        /// <returns></returns>
        public static IList<ProductType> GetList(string filters, ref string errMsg)
        {
        ...
        /// <param name="errMsg">错误信息</param>
        /// <returns></returns>
        public static long Add(ProductType model, ref string errMsg)
        {
        ...
        /// <param name="errMsg">错误信息</param>
        /// <returns></returns>
        public static bool Update(ProductType model, ref string errMsg)
        {
        ...
        /// <param name="errMsg">错误信息</param>
        /// <returns></returns>
        public static bool Delete(ProductType model, ref string errMsg)
        {
