...
namespace ZY.BLL
{
	public partial class DictionaryRefBLL
	{
		private static readonly DictionaryRefDAL dal = new DictionaryRefDAL();
		...
		/// <param name="errMsg">错误信息</param>
		/// <returns></returns>
		public static IList<DictionaryRef> GetList(string filters, string orderBy, int pageSize, int pageIndex, ref string errMsg)
		{
		...
		/// <param name="errMsg">错误信息</param>
		/// <returns></returns>
		public static IList<DictionaryRef> GetList(string filters, int pageSize, int pageIndex, ref string errMsg)
		{
		...
		/// <param name="errMsg">错误信息</param>
		/// <returns></returns>
		public static IList<DictionaryRef> GetList(string filters, string orderBy, int TopNo, ref string errMsg)
		{
		...
		/// <param name="errMsg">错误信息</param>
		/// <returns></returns>
		public static IList<DictionaryRef> GetList(string filters, string orderBy, ref string errMsg)
		{
		...
		/// <param name="errMsg">错误信息</param>
		/// <returns></returns>
		public static IList<DictionaryRef> GetList(string filters, int TopNo, ref string errMsg)
		{
		...
		/// <param name="errMsg">错误信息</param>
		/// <returns></returns>
		public static IList<DictionaryRef> GetList(string filters, ref string errMsg)
		{
		...
		/// <param name="errMsg">错误信息</param>
		/// <returns></returns>
		public static int Add(DictionaryRef model, ref string errMsg)
		{
		...
		/// <param name="errMsg">错误信息</param>
		/// <returns></returns>
		public static bool Update(DictionaryRef model, ref string errMsg)
		{
		...
		/// <param name="errMsg">错误信息</param>
		/// <returns></returns>
		public static bool Delete(DictionaryRef model, ref string errMsg)
		{
