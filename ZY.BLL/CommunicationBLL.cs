...
namespace ZY.BLL
{
	public partial class CommunicationBLL
	{
		private static readonly CommunicationDAL dal = new CommunicationDAL();
		...
		/// <param name="errMsg">错误信息</param>
		/// <returns></returns>
		public static IList<Communication> GetList(string filters, string orderBy, int pageSize, int pageIndex, ref string errMsg)
		{
		...
		/// <param name="errMsg">错误信息</param>
		/// <returns></returns>
		public static IList<Communication> GetList(string filters, int pageSize, int pageIndex, ref string errMsg)
		{
		...
		/// <param name="errMsg">错误信息</param>
		/// <returns></returns>
		public static IList<Communication> GetList(string filters, string orderBy, int TopNo, ref string errMsg)
		{
		...
		/// <param name="errMsg">错误信息</param>
		/// <returns></returns>
		public static IList<Communication> GetList(string filters, string orderBy, ref string errMsg)
		{
		...
		/// <param name="errMsg">错误信息</param>
		/// <returns></returns>
		public static IList<Communication> GetList(string filters, int TopNo, ref string errMsg)
		{
		...
		/// <param name="errMsg">错误信息</param>
		/// <returns></returns>
		public static IList<Communication> GetList(string filters, ref string errMsg)
		{
		...
		/// <param name="errMsg">错误信息</param>
		/// <returns></returns>
		public static int Add(Communication model, ref string errMsg)
		{
		...
		/// <param name="errMsg">错误信息</param>
		/// <returns></returns>
		public static bool Update(Communication model, ref string errMsg)
		{
		...
		/// <param name="errMsg">错误信息</param>
		/// <returns></returns>
		public static bool Delete(Communication model, ref string errMsg)
		{
