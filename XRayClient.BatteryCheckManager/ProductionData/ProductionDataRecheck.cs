...
{
    public class ProductionDataRecheck : ObservableObject
    {
        ...
        {
            RemoveProductionData(productionData.ProductSN);

            string sql = $"INSERT INTO recheck_production_data(`ProductSN`,`Data`,`keyValue`) VALUES('{productionData.ProductSN}','{productionData.JsonData}','{productionData.KeyValue}');";
            bool success = false;
        ...
        {
            string sql = $"DELETE FROM recheck_production_data WHERE ProductSN='{productSN}';";
            bool success = false;
            string exceptionMsg = string.Empty;
            try
            {
        ...
        {
            string sql = "SELECT id, logDateTime, ProductSN, Data, keyValue FROM recheck_production_data;";
