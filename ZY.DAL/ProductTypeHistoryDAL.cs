...
namespace ZY.DAL
{
    public partial class ProductTypeHistoryDAL
    {
        private string conStr = string.Empty;
        private DBHelper helper = null;
        public ProductTypeHistoryDAL(string serverName)
        {
        ...
        public bool IsExists(string filters, ref string errMsg)
        {
            ...
            try
            {
                ...
                strSql.Append("select count(1) from ProductTypeHistory ");
        ...
        /// <param name="errMsg">错误信息</param>
        /// <returns></returns>
        public IList<ProductTypeHistory> GetList(string filters, string orderBy, int pageSize, int pageIndex, ref string errMsg)
        {
        ...
        /// <param name="errMsg">错误信息</param>
        /// <returns></returns>
        public IList<ProductTypeHistory> GetList(string filters, int pageSize, int pageIndex, ref string errMsg)
        {
        ...
        /// <param name="errMsg">错误信息</param>
        /// <returns></returns>
        public IList<ProductTypeHistory> GetList(string filters, string orderBy, int TopNo, ref string errMsg)
        {
        ...
        /// <param name="errMsg">错误信息</param>
        /// <returns></returns>
        public IList<ProductTypeHistory> GetList(string filters, string orderBy, ref string errMsg)
        {
        ...
        /// <param name="errMsg">错误信息</param>
        /// <returns></returns>
        public IList<ProductTypeHistory> GetList(string filters, int TopNo, ref string errMsg)
        {
        ...
        /// <param name="errMsg">错误信息</param>
        /// <returns></returns>
        public IList<ProductTypeHistory> GetList(string filters, ref string errMsg)
        {
        ...
        /// <param name="errMsg">错误信息</param>
        /// <returns></returns>
        public IList<ProductTypeHistory> GetList(string filters, string orderBy, int TopNo, int pageSize, int pageIndex, ref string errMsg)
        {
            errMsg = string.Empty;
            ProductTypeHistory model = new ProductTypeHistory();
            if (string.IsNullOrEmpty(filters)) filters = " 1=1";
            StringBuilder selCmd = new StringBuilder();
            IList<ProductTypeHistory> list = new List<ProductTypeHistory>();
            try
            {
                if (pageSize != -1)
                {
                    ...
                    selCmd.Append(" FROM  ProductTypeHistory  ");
                    selCmd.AppendFormat(" where {0} and Iden >= (select Iden from ProductTypeHistory  where {0} order by {1} desc LIMIT {2},1) LIMIT {3};", filters, (string.IsNullOrEmpty(orderBy) ? "Iden" : orderBy), pageSize * pageIndex, pageSize);
                    selCmd.AppendFormat("SELECT count(1) as TotalCount from ProductTypeHistory where {0};", filters);
                }
                else
                {
                    selCmd.Append("SELECT ");
                ...
                helper = DBHelperFactory.CreateHelperFactory(Common.ConnectionString);
                list = helper.SelectReader<ProductTypeHistory>(selCmd.ToString());
            }
            catch (Exception ex)
            {
                errMsg = ex.Message;
        ...
        /// <param name="errMsg">错误信息</param>
        /// <returns></returns>
        public int Add(ProductTypeHistory model, DBHelper helper, bool isTran, ref string errMsg)
        {
            errMsg = string.Empty;
        ...
        /// <param name="errMsg">错误信息</param>
        /// <returns></returns>
        public int Add(ProductTypeHistory model, ref string errMsg)
        {
        ...
        /// <param name="errMsg">错误信息</param>
        /// <returns></returns>
        public bool Update(ProductTypeHistory model, DBHelper helper, bool isTran, ref string errMsg)
        {
            errMsg = string.Empty;
        ...
        /// <param name="errMsg">错误信息</param>
        /// <returns></returns>
        public bool Update(ProductTypeHistory model, ref string errMsg)
        {
        ...
        /// <param name="errMsg">错误信息</param>
        /// <returns></returns>
        public bool Delete(ProductTypeHistory model, DBHelper helper, bool isTran, ref string errMsg)
        {
            errMsg = string.Empty;
        ...
        /// <param name="errMsg">错误信息</param>
        /// <returns></returns>
        public bool Delete(ProductTypeHistory model, ref string errMsg)
        {
        ...
        public bool UpdateFiledsByFilters(string fileds, string filters, ref string errMsg)
        {
            errMsg = string.Empty;
            StringBuilder updCmd = new StringBuilder();
            updCmd.AppendFormat("Update ProductTypeHistory set {0} where {1} ", fileds, filters);
            try
            {
                helper = DBHelperFactory.CreateHelperFactory(Common.ConnectionString);
        ...
        public string SelectFiledsByFilters(string filedName, string filters, ref string errMsg)
        {
            ...
            try
            {
                updCmd.AppendFormat("select {0} from ProductTypeHistory where {1} LIMIT 1; ", filedName, filters);
                helper = DBHelperFactory.CreateHelperFactory(Common.ConnectionString);
