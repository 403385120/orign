...
namespace Basler_CLCameraParams
{
    ...
    {
        ContrastMode_ContrastMode_Off,  //!<
		ContrastMode_ContrastMode_Linear,  //!<
		ContrastMode_ContrastMode_S_shaped   //!<
...
The default value of the parameter is the minimum allowed number of inter-line clock cycles.
    ...
    */
    GenApi::IBoolean &DenoisingEnable;
    ...
    */
    GenApi::IEnumerationT<ContrastModeEnums > &ContrastMode;
    ...
    //@{
	/*!	
		\brief Shows the actual value of the contrast used in the function for controlling image contrast
    ...
    */
    ...
    //@{
	/*!	
		\brief Sets the 'raw' value (integer) of the constant used in the function for controlling image contrast
    ...
    */
    ...
    //@{
	/*!	
		\brief Sets the position of the pivot point used in the function for controlling image contrast
...
The range of available settings (0..255) applies to all pixel data format bit depths.
    ...
    */
    ...
    inline CCLCameraParams_Params::CCLCameraParams_Params(void)
        ...
        , DenoisingEnable( *new GenApi::CBooleanRef() )
        , Denoising( *new GenApi::CIntegerRef() )
        , Sharpness( *new GenApi::CFloatRef() )
        , SharpnessRaw( *new GenApi::CIntegerRef() )
        , ContrastMode( *new GenApi::CEnumerationTRef<ContrastModeEnums>() )
        , ContrastAbs( *new GenApi::CFloatRef() )
        , ContrastRaw( *new GenApi::CIntegerRef() )
        , ContrastPivot( *new GenApi::CIntegerRef() )
    ...
    inline CCLCameraParams_Params::~CCLCameraParams_Params(void)
    {
        ...
        delete static_cast < GenApi::CBooleanRef*> (&DenoisingEnable );
        delete static_cast < GenApi::CIntegerRef*> (&Denoising );
        delete static_cast < GenApi::CFloatRef*> (&Sharpness );
        delete static_cast < GenApi::CIntegerRef*> (&SharpnessRaw );
        delete static_cast < GenApi::CEnumerationTRef<ContrastModeEnums> *> (&ContrastMode );
        delete static_cast < GenApi::CFloatRef*> (&ContrastAbs );
        delete static_cast < GenApi::CIntegerRef*> (&ContrastRaw );
        delete static_cast < GenApi::CIntegerRef*> (&ContrastPivot );
    ...
    static_cast<GenApi::CBooleanRef*> (&DenoisingEnable )->SetReference(_Ptr->GetNode("DenoisingEnable"));
    static_cast<GenApi::CIntegerRef*> (&Denoising )->SetReference(_Ptr->GetNode("Denoising"));
    static_cast<GenApi::CFloatRef*> (&Sharpness )->SetReference(_Ptr->GetNode("Sharpness"));
    static_cast<GenApi::CIntegerRef*> (&SharpnessRaw )->SetReference(_Ptr->GetNode("SharpnessRaw"));
    static_cast<GenApi::CEnumerationTRef<ContrastModeEnums> *> (&ContrastMode )->SetReference(_Ptr->GetNode("ContrastMode"));
    static_cast<GenApi::CEnumerationTRef<ContrastModeEnums> *> (&ContrastMode )->SetNumEnums(3);
	static_cast<GenApi::CEnumerationTRef<ContrastModeEnums> *> (&ContrastMode )->SetEnumReference( ContrastMode_ContrastMode_Off, "ContrastMode_Off" );		static_cast<GenApi::CEnumerationTRef<ContrastModeEnums> *> (&ContrastMode )->SetEnumReference( ContrastMode_ContrastMode_Linear, "ContrastMode_Linear" );		static_cast<GenApi::CEnumerationTRef<ContrastModeEnums> *> (&ContrastMode )->SetEnumReference( ContrastMode_ContrastMode_S_shaped, "ContrastMode_S_shaped" );		static_cast<GenApi::CFloatRef*> (&ContrastAbs )->SetReference(_Ptr->GetNode("ContrastAbs"));
    static_cast<GenApi::CIntegerRef*> (&ContrastRaw )->SetReference(_Ptr->GetNode("ContrastRaw"));
    static_cast<GenApi::CIntegerRef*> (&ContrastPivot )->SetReference(_Ptr->GetNode("ContrastPivot"));
    ...
    static_cast<GenApi::CEnumerationTRef<FileSelectorEnums> *> (&FileSelector )->SetNumEnums(8);
