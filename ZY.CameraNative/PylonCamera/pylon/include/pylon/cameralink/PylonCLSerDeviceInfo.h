//-----------------------------------------------------------------------------
//  (c) 2007-2009 by Basler Vision Technologies
...
#include <pylon/cameralink/PylonCLSerDefs.h>
...
namespace Pylon
{
    ...
    */
    class PYLONCLSER_API CPylonCLSerDeviceInfo : public Pylon::CDeviceInfo
    {
    public:
        CPylonCLSerDeviceInfo();
        CPylonCLSerDeviceInfo(const CDeviceInfo& di);
        ...
        CPylonCLSerDeviceInfo& SetPortID( const String_t& PortIDValue);
        ...
        ///Sets the above property.
        CPylonCLSerDeviceInfo& SetDeviceID( const String_t& DeviceIDValue);
        ///Returns true if the above property is available.
        ...
        ///Sets the above property.
        CPylonCLSerDeviceInfo& SetInitialBaudRate( const String_t& InitialBaudRateValue);
        ///Returns true if the above property is available.
        ...
        ///Sets the above property.
        CPylonCLSerDeviceInfo& SetDeviceXMLFileOverride( const String_t& DeviceXMLFileOverrideValue);
        ///Returns true if the above property is available.
        ...
        ///Sets the above property.
        CPylonCLSerDeviceInfo& SetDeviceSpecificString( const String_t& DeviceSpecificStringValue);
        ///Returns true if the above property is available.
        ...
        ///Sets the above property.
        CPylonCLSerDeviceInfo& SetPortSpecificString( const String_t& PortSpecificStringValue);
        ///Returns true if the above property is available.
