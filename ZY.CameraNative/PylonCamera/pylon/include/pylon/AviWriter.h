    ...
    */
    ...
    public:
        ...
        */
        ...
        /*!
        \brief Can be used to check whether the given image can be added to the AVI file without prior conversion.
        ...
        \return Returns true if the image can be added to the AVI stream without prior conversion.
