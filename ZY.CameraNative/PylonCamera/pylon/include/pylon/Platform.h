...
PYLON_DEPRECATED("The type 'char8_t' is deprected. Please use 'int8_t' instead.")           typedef char            char8_t;
PYLON_DEPRECATED("The type 'uchar8_t' is deprected. Please use 'uint8_t' instead.")         typedef unsigned char   uchar8_t;
PYLON_DEPRECATED("The type 'pcchar8_t' is deprected. please use 'const char *' instead.")   typedef const char *    pcchar8_t;
PYLON_DEPRECATED("The type 'pchar8_t' is deprected. please use 'char *' instead.")          typedef char *          pchar8_t;
