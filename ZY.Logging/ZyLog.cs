...
namespace ZY.Logging
{
    public class ZyLog
    {
        ...
        public ZyLog()
        {
            ...
            _logFilePath = Path.Combine(this._logConfig.LogDir, DateTime.Now.ToString("yyyy"), DateTime.Now.ToString("MM"), DateTime.Now.ToString("dd"));
        ...
        public void Log(string content, LogLevels level = LogLevels.Info, string tag = "")
        {
            ...
            string lineContent = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.fff:\t") + level.ToString().ToUpper() + "\t" + tag + "\t" + content;
